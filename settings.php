...
if ($ADMIN->fulltree) {
    ...
    // Discussions Scope.
    $settings->add(new admin_setting_configselect('filter_annoto/discussionscope',
        get_string('discussionscope', 'filter_annoto'),
        get_string('discussionscopedesc', 'filter_annoto'),
        'true',
        array('false' => get_string('discussionscopesitewide', 'filter_annoto'),
    ...
    // Widget position.
    $settings->add(new admin_setting_configselect('filter_annoto/widgetposition',
        get_string('widgetposition', 'filter_annoto'),
        get_string('widgetpositiondesc', 'filter_annoto'),
        'topright',
        array('right' => get_string('positionright', 'filter_annoto'),
    ...
    // Widget overlay mode.
    $settings->add(new admin_setting_configselect('filter_annoto/widgetoverlay',
        get_string('widgetoverlay', 'filter_annoto'),
        get_string('widgetoverlaydesc', 'filter_annoto'),
        'auto',
        array('auto' => get_string('overlayauto', 'filter_annoto'),
