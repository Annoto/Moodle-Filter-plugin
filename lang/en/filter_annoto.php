...
$string['scope'] = 'Discussions Scope';
$string['scopedesc'] = 'Choose where you want to allow widget discussions: uncheck - all site (by default), check - page only';
//$string['scopesitewide'] = 'Site wide';
//$string['scopeprivate'] = 'Private in course';
