...
class filter_annoto extends moodle_text_filter {
    public function filter($text, array $options = array()) {
        ...
        $jsparams = array(
            ...
            'featureTab' => !empty($settings->tabs)?filter_var($settings->tabs, FILTER_VALIDATE_BOOLEAN):"",
            'featureCTA' => !empty($settings->cta)?filter_var($settings->cta, FILTER_VALIDATE_BOOLEAN):"",
            'loginUrl' => $loginurl,
            'logoutUrl' => $logouturl,
            'mediaTitle' => $cmtitle,
